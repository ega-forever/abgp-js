...
describe('consensus tests (3 nodes, TCP, random peer selection, links m-to-n, links >= 2f+1)', () => testSuite({}, 3, 'TCP', true,
...
describe('consensus tests (4 nodes, TCP, random peer selection, links m-to-n, links >= 2f+1)', () => testSuite({}, 4, 'TCP', true,
  new Map<number, number[]>([
    [0, [0, 1, 2]],
    [1, [1, 0, 3]],
    [2, [2, 0, 3]],
...
describe('consensus tests (5 nodes, TCP, random peer selection, links m-to-n, links >= 2f+1)', () => testSuite({}, 5, 'TCP', true,
  new Map<number, number[]>([
    [0, [0, 1, 2]],
    [1, [1, 0, 3]],
    [2, [2, 0, 4]],
